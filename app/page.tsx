          ...
          <section className="experience fade-in">
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    Спроектировал AI-агентов с нуля. 82% пользователей бета-теста (50 SMB-клиентов) создали первого агента в первую неделю, без онбординга и инструкций
                  </li>
                  <li>
                    Пересобрал модуль аналитики. Нагрузка на аналитиков и
                    разработку упала в 2 раза. Настройка отчета
                    сократилась с 45 до 8 минут
                  </li>
                  <li>
                    Запустил когортный анализ. За первый месяц после релиза, функционал начали использовать 64% крупных клиентов
                  </li>
                  <li>
                    Развивал дизайн систему. Добавил 10 новых компонентов, описал паттерны, поддерживал UI-kit, что ускорило работу над новыми фичами.
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  <li>
                    Собрал MVP, от стенда с конфликтующей логикой до продукта, готового к тесту на реальных пользователях. Внедрил базовый UI-kit и заложил основу для будущей дизайн-системы
                  </li>
                  <li>
                    Упростил создание резюме и вакансий: сократил путь с 8–9 экранов до 4 шагов. Это снизило барьер для аудитории, которая редко пользуется цифровыми сервисами
                  </li>
                </ul>
              </li>
            </ul>
