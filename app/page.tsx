        ...
        <div className="container">
          ...
          <section className="intro fade-in">
            ...
            <h2 className="subtitle">
              Привет! Я продуктовый дизайнер с 3+ годами опыта в B2B. Проектирую интерфейсы со сложной бизнес-логикой — AI-продукты, аналитика и дашборды, внутренние web-системы и превращаю их в простые и понятные UX-решения.
            </h2>
