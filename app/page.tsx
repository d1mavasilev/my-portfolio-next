        ...
        <div className="container">
          ...
          <section className="intro fade-in">
            ...
            <h2 className="subtitle">
              Привет! Я продуктовый дизайнер с 3+ годами опыта в B2B. Проектирую интерфейсы со сложной бизнес-логикой и превращаю их в понятные UX-решения. AI-продукты, аналитика и дашборды, внутренние web-системы, корпоративные интерфейсы.
            </h2>
