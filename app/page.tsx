          ...
          <section className="experience fade-in">
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    Спроектировал AI-агентов с нуля: 82% пользователей бета-теста создали первого агента в первую неделю, без онбординга и инструкций (из 50 SMB-клиентов, участвовавших в тесте)
                  </li>
                  <li>
