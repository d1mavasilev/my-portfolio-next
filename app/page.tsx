      ...
      <section className="intro fade-in">
        <h2 className="subtitle">
            ...
            <section className="approach fade-in">
              <h2>Подход</h2>
              <p>
                Проектирую с фокусом на измеримый результат: оцениваю, как решения влияют на воронку и нагрузку на поддержку. Понимаю потребности бизнеса, прорабатываю сценарии вплоть учитывая корнер-кейсы, что снижает стоимость разработки и сокращает time to market.
              </p>
            </section>
