        ...
        <div className="container">
          ...
          <section className="intro fade-in">
            ...
            <h2 className="subtitle">
              {greeting} Я продуктовый дизайнер с 3+ годами опыта в B2B SaaS. Специализируюсь на сложных аналитических интерфейсах, дашбордах, AI-продуктах, и на переводе бизнес-задач в конкретные UX-решения.
            </h2>
