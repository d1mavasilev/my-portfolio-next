        ...
        <div className="container">
          ...
          <section className="intro fade-in">
            ...
            <h2 className="subtitle">
              {greeting} Я продуктовый дизайнер с 3+ годами опыта в B2B SaaS. Привет! Я продуктовый дизайнер с 3+ годами опыта в B2B. Проектирую интерфейсы со сложной бизнес-логикой — AI-продукты, аналитика и дашборды, внутренние web-системы и превращаю их в простые и понятные UX-решения.
            </h2>
            ...
            <ul>
              <li>
                ...
                <ul className="pl-5 space-y-1 text-muted" style={{ listStyleType: '"✦ "' }}>
                  ...
                  <li>
                    Расширил дизайн-систему. Добавил 10+ новых компонентов, описал документацию и паттерны - снизил количество правок до продакшна с 3–5 до 2, сократил время на типовые задачи и новые задачи проектирования
                  </li>
                </ul>
              </li>
              <li>
